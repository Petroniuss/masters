...
pub mod using_peer_broadcast_events {
    ...
    impl<M> ::core::clone::Clone for UsingPeerBroadcastEvents<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for UsingPeerBroadcastEvents<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for UsingPeerBroadcastEvents<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for UsingPeerBroadcastEvents<M> {
    ...
    impl<M: ::ethers::providers::Middleware> UsingPeerBroadcastEvents<M> {
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            UsingPeerBroadcastEventsEvents,
        > {
            self.0
    ...
    impl ::core::fmt::Display for UsingPeerBroadcastEventsEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<PeerRegisteredFilter> for UsingPeerBroadcastEventsEvents {
        fn from(value: PeerRegisteredFilter) -> Self {
            Self::PeerRegisteredFilter(value)
        }
    }
    impl ::core::convert::From<PeerSetRegisteredFilter> for UsingPeerBroadcastEventsEvents {
