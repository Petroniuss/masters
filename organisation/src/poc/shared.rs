...
pub static ORACLE_CONTRACT_ADDRESS: &'static str = "0x19800ab132174a00e2ab1434678bbc34554cb915";
...
pub fn demo_organisation_one() -> Result<Arc<ExecutingOrganisation>> {
...
pub fn demo_organisation_two() -> Result<Arc<ExecutingOrganisation>> {
...
pub fn demo_peer_one_address() -> Address {
    Address::from_str("0xd13c4379bfc9a0ea5e147b2d37f65eb2400dfd7b").unwrap()
}

pub fn demo_peer_two_address() -> Address {
    Address::from_str("0xd248e4a8407ed7ff9bdbc396ba46723b8101c86e").unwrap()
}
...
pub fn demo_peer_ipfs_pointer() -> String {
    "https://ipfs.io/ipfs/Q43q3ARVgxv6rXqVPiikMJ8u2NLgmgszg13pYrDKEoiu".to_string()
}

pub fn create_demo_client(
    executing_organisation: Arc<ExecutingOrganisation>,
) -> Result<EnrichedEthereumClient> {
    let base_client = create_base_demo_client(executing_organisation.clone())?;
    let enriched_client =
        base_client.to_enriched_client(PEER_BROADCAST_CONTRACT_ADDRESS, ORACLE_CONTRACT_ADDRESS)?;
...
pub fn create_base_demo_client(
    ...
    let ethereum_client =
        ethereum_client::crate_local_ethereum_client(executing_organisation.clone())?;
