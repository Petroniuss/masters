...
use organisation::poc::shared::{
    create_demo_client, demo_graph_ipfs_pointer, demo_organisation_one, demo_peer_ipfs_pointer,
    demo_peer_set_with_two_peers, shared_init, DEMO_PEER_SET_SMART_CONTRACT_ADDRESS,
};
use std::str::FromStr;
...
async fn main() -> Result<()> {
    ...
    let _peer_set_smart_contract = ethereum_client
        ...
        .await?;
    assert_eq!(
        Address::from_str(DEMO_PEER_SET_SMART_CONTRACT_ADDRESS)?,
