...
use organisation::poc::shared::{
    create_demo_client, demo_organisation_two, demo_peer_set_with_two_peers,
    demo_updated_ipfs_pointer, shared_init, DEMO_PEER_SET_SMART_CONTRACT_ADDRESS,
};
...
async fn main() -> Result<()> {
    ...
    info!(
        ...
        executing_organisation, changed_ipfs, peer_set
    );
    peer_set_smart_contract.propose_change(changed_ipfs).await?;
