...
pub mod permission_graph {
    ...
    pub static PERMISSIONGRAPH_ABI: ethers::contract::Lazy<
        ethers::core::abi::Abi,
    ...
    pub static PERMISSIONGRAPH_BYTECODE:
        ethers::contract::Lazy<ethers::core::types::Bytes> =
        ethers::contract::Lazy::new(|| {
            "" . parse () . expect ("invalid bytecode")
        });
    pub struct PermissionGraph<M>(
    ...
    impl<M: ethers::providers::Middleware> PermissionGraph<M> {
        ...
        > {
            let factory =
                ethers::contract::ContractFactory::new(
                    PERMISSIONGRAPH_ABI.clone(),
            ...
            let deployer =
                ethers::contract::ContractDeployer::new(
                    deployer,
                );
            Ok(deployer)
        }
        ...
        {
            self.0.method_hash([236, 170, 19, 63], ()).expect(
        ...
        {
            self.0.method_hash([32, 117, 87, 113], ()).expect(
                "method not found (this should never happen)",
            )
        }
    ...
    impl ethers::contract::EthLogDecode for PermissionGraphEvents {
        ...
        {
            if let Ok(decoded) =
                PermissionGraphChangeRequestFilter::decode_log(
                    log,
                )
            {
    ...
    pub enum PermissionGraphCalls {
        PermissionGraphIPFSPointer(
            PermissionGraphIPFSPointerCall,
        ),
        GetLatestPermissionGraphIPFSPointer(
            GetLatestPermissionGraphIPFSPointerCall,
        ),
    ...
    impl ::std::convert::From<PermissionGraphIPFSPointerCall>
        for PermissionGraphCalls
    {
        fn from(var: PermissionGraphIPFSPointerCall) -> Self {
            PermissionGraphCalls::PermissionGraphIPFSPointer(
                var,
            )
        }
    }
    ...
    {
        fn from(
            var: GetLatestPermissionGraphIPFSPointerCall,
        ) -> Self {
        ...
        for PermissionGraphCalls
    {
        fn from(var: ProposePermissionGraphChangeCall) -> Self {
            PermissionGraphCalls::ProposePermissionGraphChange(
                var,
            )
        }
    }
    ...
    pub struct GetLatestPermissionGraphIPFSPointerReturn(
        pub String,
    );
}
