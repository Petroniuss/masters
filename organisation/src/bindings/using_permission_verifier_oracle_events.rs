...
pub mod using_permission_verifier_oracle_events {
    ...
    impl<M> std::ops::Deref for UsingPermissionVerifierOracleEvents<M> {
        type Target = ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> std::fmt::Debug for UsingPermissionVerifierOracleEvents<M> {
    ...
    impl<M: ethers::providers::Middleware> UsingPermissionVerifierOracleEvents<M> {
        ...
        pub fn events(
            &self,
        ) -> ethers::contract::builders::Event<M, UsingPermissionVerifierOracleEventsEvents>
        {
    ...
    impl ::std::fmt::Display for UsingPermissionVerifierOracleEventsEvents {
