...
pub mod peer_broadcast {
    ...
    pub static PEERBROADCAST_ABI: ethers::contract::Lazy<
        ethers::core::abi::Abi,
    ...
    pub static PEERBROADCAST_BYTECODE: ethers::contract::Lazy<
    ...
    impl ethers::contract::EthLogDecode for PeerBroadcastEvents {
            ...
            Self: Sized,
        {
            ...
            {
                return Ok(
                    PeerBroadcastEvents::PeerRegisteredFilter(
                        decoded,
                    ),
                );
            }
    ...
    impl ethers::core::abi::AbiEncode for PeerBroadcastCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                PeerBroadcastCalls::RegisterPeer(element) => {
                    element.encode()
                }
                PeerBroadcastCalls::RegisterPeerSet(
                    element,
                ) => element.encode(),
            }
        }
