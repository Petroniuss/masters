...
pub mod peer_broadcast_api {
    ...
    impl<M: ethers::providers::Middleware> PeerBroadcastAPI<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), PEERBROADCASTAPI_ABI.clone(), client)
                .into()
        }
        ...
        pub fn events(&self) -> ethers::contract::builders::Event<M, PeerBroadcastAPIEvents> {
            self.0.event_with_filter(Default::default())
        }
    }
    impl<M: ethers::providers::Middleware> From<ethers::contract::Contract<M>> for PeerBroadcastAPI<M> {
    ...
    impl ethers::core::abi::AbiEncode for PeerBroadcastAPICalls {
        fn encode(self) -> Vec<u8> {
            match self {
                PeerBroadcastAPICalls::RegisterPeer(element) => element.encode(),
                PeerBroadcastAPICalls::RegisterPeerSet(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for PeerBroadcastAPICalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                PeerBroadcastAPICalls::RegisterPeer(element) => element.fmt(f),
                PeerBroadcastAPICalls::RegisterPeerSet(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<RegisterPeerCall> for PeerBroadcastAPICalls {
        fn from(var: RegisterPeerCall) -> Self {
            PeerBroadcastAPICalls::RegisterPeer(var)
        }
    }
    impl ::std::convert::From<RegisterPeerSetCall> for PeerBroadcastAPICalls {
