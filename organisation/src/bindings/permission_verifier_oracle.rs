...
pub mod permission_verifier_oracle {
    ...
    pub static PERMISSIONVERIFIERORACLE_ABI:
    ...
    pub static PERMISSIONVERIFIERORACLE_BYTECODE:
    ...
    pub struct PermissionVerifierOracle<M>(
        ...
        PermissionVerifierOracle<M>
    {
        ...
        > {
            let factory =
                ethers::contract::ContractFactory::new(
                    PERMISSIONVERIFIERORACLE_ABI.clone(),
                    PERMISSIONVERIFIERORACLE_BYTECODE
                        .clone()
                        .into(),
                    client,
                );
        ...
        > {
            self.0.method_hash([157, 134, 105, 133], p0).expect(
    ...
    pub enum PermissionVerifierOracleCalls {
        ...
        ValidatePermissionGraphChange(
            ValidatePermissionGraphChangeCall,
        ),
    }
    impl ethers::core::abi::AbiDecode
        for PermissionVerifierOracleCalls
    {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::std::result::Result<
    ...
    impl ::std::convert::From<RequestsCall>
        for PermissionVerifierOracleCalls
    {
    ...
    impl ::std::convert::From<SubmitPeerValidationCall>
        for PermissionVerifierOracleCalls
    {
        fn from(var: SubmitPeerValidationCall) -> Self {
            PermissionVerifierOracleCalls::SubmitPeerValidation(
                var,
            )
        }
    }
    impl ::std::convert::From<ValidatePermissionGraphChangeCall>
        for PermissionVerifierOracleCalls
    {
        fn from(
            var: ValidatePermissionGraphChangeCall,
        ) -> Self {
    ...
    pub struct ValidatePermissionGraphChangeReturn(
        pub [u8; 32],
    );
}
