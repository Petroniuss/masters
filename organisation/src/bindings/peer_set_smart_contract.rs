...
pub mod peer_set_smart_contract {
    ...
    pub static PEERSETSMARTCONTRACT_ABI:
    ...
    pub static PEERSETSMARTCONTRACT_BYTECODE:
    ...
    pub struct PeerSetSmartContract<M>(
    ...
    impl<M: ethers::providers::Middleware> PeerSetSmartContract<M> {
        ...
        > {
            self.0.method_hash([125, 192, 209, 208], ()).expect(
                "method not found (this should never happen)",
            )
        }
        ...
        pub fn peer_requesting_change(
            ...
            ethers::core::types::Address,
        > {
            self.0.method_hash([233, 173, 28, 15], ()).expect(
                "method not found (this should never happen)",
            )
        }
        ...
        {
            self.0.method_hash([197, 255, 109, 14], ()).expect(
                "method not found (this should never happen)",
            )
        }
        ...
        {
            self.0.method_hash([28, 133, 144, 186], p0).expect(
                "method not found (this should never happen)",
            )
        }
        ...
        {
            self.0.method_hash([25, 31, 91, 3], ()).expect(
                "method not found (this should never happen)",
            )
        }
        ...
        {
            self.0.method_hash([244, 56, 6, 175], ()).expect(
                "method not found (this should never happen)",
            )
        }
        ...
        for PeerSetSmartContractEvents
    {
            ...
            Self: Sized,
        {
            ...
            {
                return Ok(PeerSetSmartContractEvents::PeerSetPermissionGraphUpdatedFilter(decoded));
            }
    ...
    #[ethcall(
        name = "peerRequestingChange",
        abi = "peerRequestingChange()"
    )]
    ...
    #[ethcall(
        name = "pendingGraphIPFSPointer",
        abi = "pendingGraphIPFSPointer()"
    )]
    ...
    pub enum PeerSetSmartContractCalls {
        ...
        PeerSetPermissionGraphIPFSPointer(
            PeerSetPermissionGraphIPFSPointerCall,
        ),
        Peers(PeersCall),
    ...
    impl ::std::convert::From<PeerRequestingChangeCall>
        for PeerSetSmartContractCalls
    {
    ...
    {
        fn from(
            var: PeerSetPermissionGraphIPFSPointerCall,
        ) -> Self {
            PeerSetSmartContractCalls::PeerSetPermissionGraphIPFSPointer(var)
        }
    }
    impl ::std::convert::From<PeersCall>
        for PeerSetSmartContractCalls
    {
    ...
    impl ::std::convert::From<PendingGraphIPFSPointerCall>
        for PeerSetSmartContractCalls
    {
        fn from(var: PendingGraphIPFSPointerCall) -> Self {
            PeerSetSmartContractCalls::PendingGraphIPFSPointer(
                var,
            )
        }
    }
    impl ::std::convert::From<PendingRequestIdCall>
        for PeerSetSmartContractCalls
    {
    ...
    pub struct PeerRequestingChangeReturn(
    ...
    pub struct PeerSetPermissionGraphIPFSPointerReturn(
        pub String,
    );
